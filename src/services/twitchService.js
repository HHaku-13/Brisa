...
/** Récupère les infos publiques (avatar, display_name) d'un compte Twitch. Retourne null si introuvable. */
export async function getTwitchUserInfo(username) {
    try {
        ...
        logger.error(`Error fetching Twitch user info for ${username}:`, error);
        return null;
    }
}
